...
<table class="margin-top" id="stages">
	<thead>
		<tr>
	...
	<tbody>
		<tr>
			<td><a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/stage0">Stage 0</a></td>
			<td>Duct cell or lobular in situ</td>
			<td>92%</td>
		</tr>
		<tr>
			<td><a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/stage1">Stage I</a></td>
			<td>Invasive carcinoma, &lt;2 cm <br> No metastasis</td>
			<td>87%</td>
		</tr>
		<tr>
			<td><a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/stage2">Stage II</a></td>
			<td>Invasive carcinoma, &lt;5 cm <br> Involved axillary nodes <br> No distant metastasis</td>
			<td>75%</td>
		</tr>
		<tr>
			<td><a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/stage3">Stage III</a></td>
		...
		<tr>
			<td><a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/stage4.php">Stage IV</a></td>
