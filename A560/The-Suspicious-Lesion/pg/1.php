...
<div class="row margin-top clearfix">
	<div class="list-item col-sm-4">
		<a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/thymus" class="btn btn-default">Thymus</a>
	</div>
	<div class="list-item col-sm-4">
		<a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/lymph_node" class="btn btn-default">Lymph Node</a>
	</div>
	<div class="list-item col-sm-4">
		<a href="<?php echo BASE_URL; ?>A560/The-Suspicious-Lesion/ans/spleen" class="btn btn-default">Spleen</a>
	</div>
</div>
