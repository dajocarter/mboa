...
<div class="row cases margin-top-lg">
  ...
  <div class="col-xs-12 margin-top-lg">
    <a class="round-img" href="/A560/Pre-Test"><img src="<?php echo BASE_URL; ?>assets/img/mm-pg1.png"></a>
    <h3><a href="/A560/Pre-Test">Pre-Test</a></h3>
  </div>
</div>
...
<div class="row extras margin-top-lg">
  ...
  <div class="col-md-4 margin-top-lg">
    <a class="round-img" href="/A560/Learning-Objectives"><img src="<?php echo BASE_URL; ?>assets/img/adrenal1I4-1d.jpg"><i class="icon ion-ios-checkmark-empty"></i></a>
    <h3><a href="/A560/Learning-Objectives">Learning Objectives</a></h3>
    <p>View the <a href="/A560/Learning-Objectives">learning objectives</a> for these cases and see which cases the objectives can be found.</p>
  </div>
  <div class="col-md-4 margin-top-lg">
    <a class="round-img" href="javascript:void(0)"><img src="<?php echo BASE_URL; ?>assets/img/myocard1H2-1L.jpg"><i class="icon ion-ios-help-empty"></i></a>
  ...
  <div class="col-md-4 margin-top-lg">
    <a class="round-img" href="javascript:void(0)"><img src="<?php echo BASE_URL; ?>assets/img/Hyaline2D5-1d.jpg"><i class="icon ion-ios-cloud-download-outline"></i></a>
    <h3>Download Links</h3>
    <p>Download the HAPS 2015 Workshop Presentation as a <a href="<?php echo BASE_URL; ?>files/pptx.php">.pptx file</a>,
    a <a href="<?php echo BASE_URL; ?>files/ppt.php">.ppt file</a>, or a <a href="<?php echo BASE_URL; ?>files/pdf.php">.pdf file</a>. Also available for download is my <a href="<?php echo BASE_URL; ?>files/poster.php">AAA 2015 poster</a>.</p>
  </div>
