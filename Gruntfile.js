  ...
  grunt.initConfig({
    ...
    concat: { 
      js: {
        ...
        src: ['src/js/vendor/firebase.js', 'src/js/vendor/jquery.min.js', 'src/js/vendor/bootstrap.min.js', 'src/js/vendor/jquery.magnific-popup.min.js', 'src/js/vendor/velocity.min.js', 'src/js/main.js'],
