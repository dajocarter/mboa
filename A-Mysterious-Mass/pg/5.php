...
<p class="bold">Why is this system slow to respond initially but faster with subsequent infections?</p> 
<div>
...
<p>Although T-lymphoblasts (thymocytes) develop and mature in the thymus, they do not originate there.</p>
...
<div class="img-split grid-container clearfix">
	...
	<div class="list-item last half">
		<img src="<?php echo BASE_URL; ?>assets/img/mm-positive-selection.png">
	</div>
</div>

<p class="bold">What is positive selection?</p> 
<div>
