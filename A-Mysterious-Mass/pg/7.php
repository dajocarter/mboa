...
<p class="back-link">Nice work! <a href="<?php echo BASE_URL; ?>A-Mysterious-Mass/pg/1.php">Return to the beginning of the case and play again!</a> Try selecting other options to verify you understand <span class="italic">why</span> an answer was incorrect before moving on.</p>
